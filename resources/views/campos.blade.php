    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function resultado(){
                    ...
                    document.getElementById("resdata").value = "DSM";
            }
            var fecha1 = new Date();
    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <div id="info">Informacion - 1</div>
                <div class="info">Informacion - 2a</div>
                <div class="info">Informacion - 2b</div>
                <textarea name="info" row="5" cols="50">Informacion - 3</textarea>
                <br><br>
                <hr>
                <p id="fecha">-- -- -- -- --</p>
                <hr>
