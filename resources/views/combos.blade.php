                    ...
                    <tr>
                        ...
                        <td>
                            <select name="id_municipio" id="selc_municipio">
                                <option value="0">-- Seleccion un Estado antes</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                    $('#selc_estados').on('change', function(){
                            ...
                            if($.trim(id_estado) != '0'){
                                    $.get('js02' , {id_estado: id_estado}, function(municipios){
                                            ...
                                            $('#selc_municipios').append("<option value='0'>-- Selecciona un municipio--</option>");
                                    ...
                                    $('#selc_municipios').empty();
                                    $('#selc_municipios').append("<option value='0'>--Selecciona un estado antes --</option>");
                            }
                    });
                    //---------------------------------------------------------------------------------------------------------------------
                    $('#selc_municipios').on('change', function(){
                            ...
                            if(id_municipio > 0){
                                    $('#info').load('js02b?id_municipio=' + id_municipio).css({ "background":"#0CE"})
                            }
                            else{ $("info").html(''); }
