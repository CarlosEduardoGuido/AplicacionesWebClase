        ...
        <script type="text/javascript">
            function validar1(obj){
                    ...
                    if(pass.search(/[a-z]/i) < 0){
                            ...
                            alert("La contraseña si contiene letras");
                    }
                    if(pass.search(/[0-9]/) < 0){
                            alert("Error: la contraseña no contiene numeros")
                    }
            }        
            //-----------------------------------------------------------------------
            function validar2(obj){
                    ...
                    if(pass.search(/[A-Z]/g)+1 > 0){
                            ...
                            if(pass.search(/[a-zA-Z0-9]/g)+1 > 0){
                                    ...
                                    document.getElementById('error').innerHTML = "Error: la contraseña debe contener letras y numeros";
                            }
                            */
                    ...
                    if(cont > 0){
                            document.getElementById('pass2').style.cssText = "color: #F00; border: solid 1px #F00; ";
                            document.getElementById('error').innerHTML = "Error: la contraseña debe contener solo letras y numeros" + cont;;
                            cont=0;
                    }
